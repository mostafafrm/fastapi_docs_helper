...
All this extension does is to prevent the top announcement banner from shrinking, so the reader doesn't gets annoyed by all the text down the page jumping up and down.
